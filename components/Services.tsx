...
const Services = () => {
  return (
    <section className='relative max-container padding-container flex md:flex-row xs:flex-col py-10 md:h-[420px] xs:h-full gap-0'>
      ...
      <div className='right xs:w-full md:w-3/5 py-4 px-4 flex justify-center  gap-4 hide-scrollbar overflow-x-auto'>
