  ...
  return (
    <section className='max-container padding-container py-20 gap-16 flex md:flex-row xs:flex-col'>
      ...
      <div className='pt-14 relative right flex xs:w-full md:w-1/2'>
        ...
        <Image className='z-20 w-[60%] h-[90%] rounded-3xl' src='/feat1.jpg' alt='feature' width={500} height={500} />
        <Image className='z-30 absolute w-[50%] h-[65%] top-[45%] left-[30%]' src='/feat2.jpg' alt='feature' width={500} height={500} /> 
